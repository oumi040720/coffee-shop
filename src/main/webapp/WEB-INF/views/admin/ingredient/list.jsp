        					...
        					<div class="card-box">
        						...
        						<div>
        							<table id="datatable" 
        								...
        								<tbody>
        									<c:forEach items="${ingredients}" var="category">
        										<tr>
        											<td>${ingredient.name}</td>
        											<td>${ingredient.quantity}</td>
        											<td>
        												<c:url var="editURL" value="/admin/ingredient/edit">
        													<c:param name="ingredient_code" value="${ingredient.ingredientCode}" />
        												</c:url>
        												...
        												<a href="#" class="btn btn-outline-danger" data-toggle="modal" data-target="#confirm-${category.ingredientCode}">
        													<i class="mdi mdi-window-close"></i>
        												</a>
        												<div class="modal fade" id="confirm-${ingredient.ingredientCode}">
        													<div class="modal-dialog modal-dialog-centered">
        														<div class="modal-content">
	        														...
	        														<div class="modal-body">
	        															Bạn có chắc muốn xóa thể loại "${ingredient.name}" không?
	        														</div>
