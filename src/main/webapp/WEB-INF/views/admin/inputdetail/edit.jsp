							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input id="inputDate" Class="form-control"
												readonly="readonly" value="${inputDate}" />
										</div>
									</div>
									<div class="form-group row">
								...
								<div class="col-md-6 col-xl-3 natural personal">
									<div class="gallery-box">
										...
										<h4 class="font-16 mt-0">${menu.productName}</h4>
											<input id="inputDate" Class="form-control"
												readonly="readonly" value="${inputDate}" hidden=""/> 
											<input
		...
		function minus(id) {
			...
			function selected(obj) {
			  ...
			  $('#submit').on('click', () => {
				...
				var ordercode = new String('${order.inputDate}');
			...
			function edit(index) {
				...
				document.getElementById("inputDate").value = orderDetail.order;
			...
			function deleete(index) {
				...
				var inputDate = document.getElementById("inputDate-"+index);
			...
			$(document).ready(function(){
				$( "#returnProduct" ).click(function() {
					window.location.href="${domainURL}/orderdetail/editDetail?inputDate=${inputDate}";
					});
				});
