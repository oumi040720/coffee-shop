...
public interface ICustomersRepository extends JpaRepository<CustomersEntity, Long> {
	...
	public List<CustomersEntity> findAllByFullnameContainingOrEmailContainingOrPhoneContainingOrAddressContaining(
			String fullname, String email, String phone, String address);

	public Page<CustomersEntity> findAllByFullnameContainingOrEmailContainingOrPhoneContainingOrAddressContaining(
			String fullname, String email, String phone, String address, Pageable pageable);

	public List<CustomersEntity> findAllByFlagDeleteIsAndFullnameContainingOrEmailContainingOrPhoneContainingOrAddressContaining(
			Boolean flagDelete, String fullname, String email, String phone, String address);

	public Page<CustomersEntity> findAllByFlagDeleteIsAndFullnameContainingOrEmailContainingOrPhoneContainingOrAddressContaining(
