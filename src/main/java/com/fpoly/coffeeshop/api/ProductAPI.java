...
public class ProductAPI {
	...
	@GetMapping(value = "/api/prodct/list")
	public List<ProductDTO> findAll(){
		return productService.findAll();
	}
	
	@GetMapping(value = "/api/prodct/list/category_code/{category_code}")
	...
	@GetMapping(value = "/api/prodct/list/flag_delete/{flag_delete}")
	...
	@GetMapping(value = "/api/prodct/flag_delete/total_pages")
	...
	@GetMapping(value = "/api/prodct/flag_delete/list")
	...
	@GetMapping(value = "/api/prodct/list/search/{key}")
	...
	@GetMapping(value = "/api/prodct/search/total_pages")
	...
	@GetMapping(value = "/api/prodct/search/list")
	...
	@GetMapping(value = "/api/prodct/flag_delete/{flag_delete}/search/{key}")
	...
	@GetMapping(value = "/api/prodct/flag_delete/search/list")
